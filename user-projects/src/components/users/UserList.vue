...
export default {
  ...
  setup(props) {
    ...
    const [enteredSearchTerm, activeSearchTerm, availableUsers, updateSearch] = useSearch(users, 'fullName');

    const [sorting, displayedUsers, sort] = useSort(availableUsers, 'fullName');
